    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('data_nilai.update', $nilai->id) }}" method="post"
                        ...
                        <div class="mb-3">
                            ...
                            <select name="id_guru" class="form-control @error('id_guru') is-invalid @enderror">
                                ...
                                <option value="{{ $data->id }}" {{ $data->id == $nilai->id_guru ? 'selected' : '' }}>
                                    {{ $data->nip}}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="id_siswa" class="form-control @error('id_siswa') is-invalid @enderror">
                                ...
                                <option value="{{ $data->id }}" {{ $data->id == $nilai->id_siswa ? 'selected' : '' }}>
                                    {{ $data->nis}}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="id_kelas" class="form-control @error('id_kelas') is-invalid @enderror">
                                ...
                                <option value="{{ $data->id }}" {{ $data->id == $nilai->id_kelas ? 'selected' : '' }}>
                                    {{ $data->kelas}}
                                </option>
                                @endforeach
                            </select>

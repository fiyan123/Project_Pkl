...
<head>
    ...
    <title>Penilaian Akademik Siswa | Guru</title>
...
{{-- 
    ...
    <script src="{{ asset('assets1/js/sb-admin-2.min.js') }}"></script>
    ...
    <script src="{{ asset('assets1/js/demo/chart-pie-demo.js') }}"></script>
